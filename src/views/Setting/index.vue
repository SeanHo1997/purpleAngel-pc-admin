      ...
      <el-tabs v-model="activeTab">
        <el-tab-pane label="注册与访问" name="first">
          ...
          <el-form-item label="密码最小长度">
            <el-input type="number" v-model="form.password_min" placeholder="密码最小长度" style="width: 30%;"></el-input>
          </el-form-item>
        ...
        <el-tab-pane label="上传设置" name="second">
          <el-form-item label="默认上传方式">
            <el-radio-group v-model="form.upload_method">
              <el-radio label="oss" border>OSS独享存储</el-radio>
            </el-radio-group>
          </el-form-item>
          ...
          <el-form-item label="空间域名">
            <el-input v-model="form.upload_config.http" placeholder="http" style="width: 30%;"></el-input>
            <small class="ml-2 text-gray-500">请补全http://或https://</small>
          </el-form-item>
        </el-tab-pane>
        <el-tab-pane label="API安全" name="third">
          ...
          <el-form-item label="秘钥">
            ...
            <small class="ml-2 text-gray-500">秘钥设置关系系统中api调用传输签名串的编码规则，以及会员token解析，请慎重设置，注意设置之后对应会员要求重新登录设置token</small>
          </el-form-item>
        </el-tab-pane>
      </el-tabs>
      <el-form-item>
        <el-button type="primary" size="default" @click="update">保存</el-button>
      </el-form-item>
    </el-form>
  </el-card>
</template>
